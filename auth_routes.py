...
def criar_token(id_usuario, duracao_token=timedelta(minutes= ACCESS_TOKEN_EXPIRE_MINUTS)):
...
async def criar_conta(usuario_schema: UsurarioSchema, session: Session = Depends(pegar_sessao)): 
